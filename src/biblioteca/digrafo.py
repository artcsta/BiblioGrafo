...
class Digrafo:
    ...
    def adicionarAresta(self, u, v, peso=1):
        ...
        #isso ajuda otimizar o tempo pra consultar o grau do vértice de um dígrafo
    ...
    #     grau_saida = 0
    #
    #     for vertice in self.lista_de_adjacencia.values():
    #         print("vertice",vertice)
    #         for destino in vertice:
    ...
    def bf(self,vertice_inicial):
        ...
        for u,v,peso in self.lista_de_arestas:
            if distancias[v] > distancias[u] + peso:
                raise ValueError("O grafo contém um ciclo negativo alcançável a partir do vértice inicial.")
                # encontrou um ciclo negativo pois foi possivel fazer mais relaxamentos
    ...
    def dfs_ciclo(self, vertice, visitados, caminho_atual, ciclos, tamanho_minimo):
        ...
        for vizinho, _ in self.lista_de_adjacencia[vertice]:  # ignoro o peso da aresta
            ...
            if visitados.get(vizinho, 0) == 1:  # significa que ele já foi visitado alguma vez, portanto ciclo!
                ciclo = caminho_atual[caminho_atual.index(vizinho):] + [
                    vizinho]  # faço slicing da primeira ocorrencia do vizinho até esta
